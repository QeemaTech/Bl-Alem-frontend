...
export const instructorApi = {
  ...
  createCourseResource: (courseId: string | number, payload: Record<string, unknown>) => unwrap<any>(apiClient.post(`/instructor/courses/${courseId}/resources`, payload)),
  deleteResource: (id: string | number) => unwrap<any>(apiClient.delete(`/instructor/resources/${id}`)),
  deleteCourseResource: (id: string | number) => unwrap<any>(apiClient.delete(`/instructor/course-resources/${id}`)),
