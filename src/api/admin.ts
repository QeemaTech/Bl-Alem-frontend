...
export const adminApi = {
  ...
  payments: (params?: Record<string, string>) => unwrap<any[]>(apiClient.get('/admin/payments', q(params))), payment: (id: number | string) => unwrap<any>(apiClient.get(`/admin/payments/${id}`)), refundPayment: (id: any) => unwrap<any>(apiClient.patch(`/admin/payments/${id}/refund`)),
  coupons: (params?: Record<string, string>) => unwrap<any[]>(apiClient.get('/admin/coupons', q(params))), coupon: (id: any) => unwrap<any>(apiClient.get(`/admin/coupons/${id}`)), createCoupon: (p: any) => unwrap<any>(apiClient.post('/admin/coupons', p)), updateCoupon: (id: any, p: any) => unwrap<any>(apiClient.put(`/admin/coupons/${id}`, p)), deleteCoupon: (id: any) => unwrap<any>(apiClient.delete(`/admin/coupons/${id}`)), couponStatus: (id: any, status: string) => unwrap<any>(apiClient.patch(`/admin/coupons/${id}/status`, { status })),
  referrals: (params?: Record<string, string>) => unwrap<any[]>(apiClient.get('/admin/referrals', q(params))),
  rewards: (params?: Record<string, string>) => unwrap<any[]>(apiClient.get('/admin/rewards', q(params))),
  rewardStats: () => unwrap<any>(apiClient.get('/admin/rewards/stats')),
  referralStudents: (params?: Record<string, string>) => unwrap<any[]>(apiClient.get('/admin/rewards/students', q(params))),
  referralStudentHistory: (id: any) => unwrap<any>(apiClient.get(`/admin/rewards/students/${id}/history`)),
  setStudentReferralStatus: (id: any, enabled: boolean) => unwrap<any>(apiClient.patch(`/admin/rewards/students/${id}/referral-status`, { enabled })),
  resetStudentRewardPoints: (id: any) => unwrap<any>(apiClient.patch(`/admin/rewards/students/${id}/reset-points`)),
  rewardStatus: (id: any, status: string) => unwrap<any>(apiClient.patch(`/admin/rewards/${id}/status`, { status })),
  ...
  regenerateCertificate: (id: any) => unwrap<any>(apiClient.post(`/admin/certificates/${id}/regenerate`)),
  ...
  supportFaqs: (params?: Record<string, string>) => unwrap<any[]>(apiClient.get('/admin/support-faqs', q(params))),
  supportFaq: (id: number | string) => unwrap<any>(apiClient.get(`/admin/support-faqs/${id}`)),
  createSupportFaq: (payload: any) => unwrap<any>(apiClient.post('/admin/support-faqs', payload)),
  updateSupportFaq: (id: number | string, payload: any) => unwrap<any>(apiClient.put(`/admin/support-faqs/${id}`, payload)),
  deleteSupportFaq: (id: number | string) => unwrap<any>(apiClient.delete(`/admin/support-faqs/${id}`)),
  supportFaqStatus: (id: number | string, status: string) => unwrap<any>(apiClient.patch(`/admin/support-faqs/${id}/status`, { status })),
