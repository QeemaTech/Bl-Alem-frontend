...
export const adminApi = {
  ...
  categories: (params?: Record<string, string>) => unwrap<any[]>(apiClient.get('/admin/categories', q(params))), category: (id: number | string) => unwrap<any>(apiClient.get(`/admin/categories/${id}`)), createCategory: (p: any) => unwrap<any>(apiClient.post('/admin/categories', p)), updateCategory: (id: any, p: any) => unwrap<any>(apiClient.put(`/admin/categories/${id}`, p)), deleteCategory: (id: any) => unwrap<any>(apiClient.delete(`/admin/categories/${id}`)), categoryStatus: (id: any, status: string) => unwrap<any>(apiClient.patch(`/admin/categories/${id}/status`, { status })),
  ...
  reviews: (params?: Record<string, string>) => unwrap<any[]>(apiClient.get('/admin/reviews', q(params))),
  review: (id: number | string) => unwrap<any>(apiClient.get(`/admin/reviews/${id}`)),
  deleteReview: (id: any) => unwrap<any>(apiClient.delete(`/admin/reviews/${id}`)),
  notifications: (params?: Record<string, string>) => unwrap<any[]>(apiClient.get('/admin/notifications', q(params))),
  notification: (id: number | string) => unwrap<any>(apiClient.get(`/admin/notifications/${id}`)),
  markNotificationRead: (id: number | string) => unwrap<any>(apiClient.patch(`/admin/notifications/${id}/read`)),
  sendNotification: (p: any) => unwrap<any>(apiClient.post('/admin/notifications/send', p)),
