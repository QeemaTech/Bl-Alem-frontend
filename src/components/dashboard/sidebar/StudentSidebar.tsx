...
import { useStudentSidebarBadges } from './useStudentSidebarBadges';
...
export function StudentSidebar({
  ...
  const badges = useStudentSidebarBadges();
  ...
  return (
    <aside
      ...
      aria-label={t('aria.studentSidebar')}
      onTouchStart={handleTouchStart}
      onTouchEnd={handleTouchEnd}
    >
      <SidebarHeader isCollapsed={collapsed} onToggleCollapse={onToggleCollapse} />

      <nav className="sidebar-nav" aria-label={t('aria.studentNav')}>
        {studentNavSections.map((section, index) => (
          <SidebarSection
            key={section.id}
